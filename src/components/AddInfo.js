  ...
  const formatInput = (e) => {
    let checkIfNum;
     if (e.key !== undefined) {
       ...
       // Check if it's a "e" (69), "." (190), "+" (187), "-" (189) or "," (188) 
        checkIfNum = e.keyCode === 69 || e.keyCode === 190 || e.keyCode === 187 || e.keyCode === 189 || e.keyCode === 188;
    }
  ...
  return (
    <>
      ...
      <form onSubmit={handleVerification}>
        <div className="min-h-screen w-full bg-gray-100 text-xl text-white flex items-center">
          <div className="container mx-auto max-w-md  shadow-md hover:shadow-lg transition duration-300">
            <div className="py-6 p-10 bg-white flex flex-col content-center rounded-xl">
              <img className="w-1/5" src={icono} alt="" />
              <div className="mb-4">
              ...
              <div>
                ...
                {/* Aca va el footer */}
                <img className="pt-8" src={footer} alt="" />
              </div>
            </div>
          </div>
        </div>
